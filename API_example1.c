...
int main()
{
	...
	create_assert(ctx, create_bin_expr(OP_BVULT, create_id("a"), create_const_expr(10, 16)));
	create_assert(ctx, create_bin_expr(OP_BVULT, create_id("b"), create_const_expr(10, 16)));
	create_assert(ctx, create_bin_expr(OP_BVULT, create_id("c"), create_const_expr(10, 16)));
	create_assert(ctx, create_bin_expr(OP_BVULT, create_id("d"), create_const_expr(10, 16)));
	create_assert(ctx, create_bin_expr(OP_BVULT, create_id("e"), create_const_expr(10, 16)));
	create_assert(ctx, create_bin_expr(OP_BVULT, create_id("f"), create_const_expr(10, 16)));

	struct expr* t1=create_bin_expr(OP_BVMUL, create_id("a"), create_const_expr(215, 16));
	struct expr* t2=create_bin_expr(OP_BVMUL, create_id("b"), create_const_expr(275, 16));
	struct expr* t3=create_bin_expr(OP_BVMUL, create_id("c"), create_const_expr(335, 16));
	struct expr* t4=create_bin_expr(OP_BVMUL, create_id("d"), create_const_expr(355, 16));
	struct expr* t5=create_bin_expr(OP_BVMUL, create_id("e"), create_const_expr(420, 16));
	struct expr* t6=create_bin_expr(OP_BVMUL, create_id("f"), create_const_expr(580, 16));
	...
	while (check_sat(ctx)==1)
	{
		...
		t1=create_bin_expr(OP_EQ, create_id("a"), create_const_expr(solution_a, 16));
		t2=create_bin_expr(OP_EQ, create_id("b"), create_const_expr(solution_b, 16));
		t3=create_bin_expr(OP_EQ, create_id("c"), create_const_expr(solution_c, 16));
		t4=create_bin_expr(OP_EQ, create_id("d"), create_const_expr(solution_d, 16));
		t5=create_bin_expr(OP_EQ, create_id("e"), create_const_expr(solution_e, 16));
		t6=create_bin_expr(OP_EQ, create_id("f"), create_const_expr(solution_f, 16));
